...
void brain::setX(int new_x){
    ...
    else if (new_x > max_width-fish_width-10) place.setX(max_width-fish_width-10);
...
void brain::setY(int new_y){
    ...
    else if (new_y > max_height-fish_height-100) place.setY(max_height-fish_height-100);
